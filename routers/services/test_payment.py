"""Эмуляция создания транзакции с уникальным идентификатором и вычисление подписи из другого сервиса"""
...
data = {
    ...
    "amount": 10000.0,  # Указываем сумму пополнения (Должно быть вещественным числом, pydantic приводит к типу float)
}
